...
<form method="POST" enctype="multipart/form-data">
	...
	<div style="position: relative; width: 99%; margin-right: 0; height: 50px;">
		<input type="button" class="AddTimeline" value="New Timeline" onclick="addTimeline(<?php echo is_array($max_short_id) && count($max_short_id) > 0 ?  esc_js($max_short_id[0]->id+1) : 1 ;?>)">
			...
			<table class="RW_TI_Table_2">
				<?php for($i=0;$i<count($get_timeline);$i++) {
					...
					<tr class="RW_TI_Table_2_Tr">
						...
						<td onclick="rw_ti_copy(<?php echo esc_js($get_timeline[$i]->id);?>)"><i class="rw_ti_fileso rich_web rich_web-files-o"></i></td>
						<td onclick="rw_ti_edit(<?php echo esc_js($get_timeline[$i]->id);?>)"><i class="rw_ti_pencil rich_web rich_web-pencil"></i></td>
						<td onclick="rw_ti_del(<?php echo esc_js($get_timeline[$i]->id);?>)"><i class="rw_ti_trash rich_web rich_web-trash"></i></td>
					</tr>
				<?php } ?>
			</table>
		</div>
