<?php
	...
	*/
	...
	function Rich_Web_Timeline_Admin_Init() {
		wp_enqueue_script('rich-web-timeline-tinymce', plugins_url('/Scripts/tinymce.min.js', __FILE__), array('jquery'), null, true);
		wp_enqueue_script('rich-web-timeline-tinymce-min', plugins_url('/Scripts/jquery.tinymce.min.js', __FILE__), array('jquery'), null, true);
		...
		wp_localize_script('rich-web-timeline-admin-scripts', 'object', array('ajaxurl' => admin_url('admin-ajax.php'),'rw_timeline_nonce' => wp_create_nonce('rw_timeline_nonce') ));
	 	wp_enqueue_script('jquery');
